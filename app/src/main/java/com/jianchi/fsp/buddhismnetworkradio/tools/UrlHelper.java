...
public class UrlHelper {
    ...
    private static final String channelsUrl  = "https://amtbapi.amtb.de/amtbtv/channels/mp3";
    ...
    private static final String filesUrl  = "https://amtbapi.amtb.de/amtbtv/medias/%s/mp3";
    //                                            http://amtbapi.amtb.de/amtbtv/medias/21-786/mp3
